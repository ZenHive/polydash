defmodule PolydashWeb.Router do
  ...
  # scope "/api", PolydashWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:polydash, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PolydashWeb.Telemetry
  ...
  scope "/", PolydashWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PolydashWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", PolydashWeb do
    ...
    live_session :current_user,
      on_mount: [{PolydashWeb.UserAuth, :mount_current_scope}] do
