defmodule Polydash.Accounts do
  @moduledoc """
  ...
  alias Polydash.Accounts.UserNotifier
  alias Polydash.Accounts.UserToken
  alias Polydash.Repo

  @type email_changeset_opts :: [{:validate_unique, boolean()}]
  @type password_changeset_opts :: [{:hash_password, boolean()}]
  ...
  See `Polydash.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  """
  @spec change_user_email(User.t(), map(), email_changeset_opts()) :: Ecto.Changeset.t()
  ...
  See `Polydash.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  """
  @spec change_user_password(User.t(), map(), password_changeset_opts()) :: Ecto.Changeset.t()
  ...
  """
  @spec deliver_login_instructions(User.t(), (String.t() -> String.t())) :: {:ok, Swoosh.Email.t()}
